...
const CarouselData = [
    {
        image: firstImage,
        heading: 'Create QR Codes for Images',
        text: 'Easily generate QR codes that link to your images. Share high-quality pictures quickly and conveniently with anyone by simply scanning the code.',
        alt:'firstImage',
    },
    {
        image: secondImage,
        heading: 'Generate QR Codes for PDF Files',
